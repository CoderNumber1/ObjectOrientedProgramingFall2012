@GameMetadata(displayName = "Baseball")
public class Baseball implements IGame {
    ...
    public String getGameStatus(){
        if(this.gameWon){
            ...
            return String.format("Strike(s): %d Ball(s): %d (key: %s)", this.strikes, this.balls, this.key);
        }
    }
    
    @Override
    public String getGameInstruction() {
        return String.format("Guess three numbers: ");
    }
    ...
    @Override
    public int getScore() {
        return 100 - (this.guessCount > 1 ? this.guessCount * 5 : 0);
    }
    // </editor-fold>
